    ...
    if (filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)) {
      ...
      if(ctype_alnum($_POST['password'])) {
        ...
        if($result){
          ...
          $error = "Bir hata oluştu, neden bilmiyorum!";
...
<!-- Content -->
          ...
          <h1 class="cover-heading">Kayıt ol</h1>
...
<!-- Error end -->
            ...
            <button type="submit" class="btn btn-lg btn-secondary btn-block">Kayıt ol</button>
